...
# webshot2::webshot("http://127.0.0.1:5899/app.Rmd", file = "screenshot.png", delay = 10)
library(tidyverse)
library(scales)
library(shiny)
library(jpeg)
...
# sliderInput("k", "K for colors", min = 2, max = 10, value = 5, width = "100%")

shinyWidgets::sliderTextInput(
  "k",
  tags$span("Parameter \\(k\\) for kmeans"),
  grid = TRUE,
  force_edges = TRUE,
  selected = 6,
...
shiny::checkboxInput("use_xy", tags$small("Use position for clustering"))

shiny::checkboxInput("scale", tags$small("Scale to \\([0, 1]\\) columns before kmeans"))
...
#   k = 4,
#   use_xy = FALSE,
#   scale = sample(c(TRUE, FALSE), size = 1),
#   show_axes = FALSE
#   ); input
