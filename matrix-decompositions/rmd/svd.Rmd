...
cat(
  str_c(
    ...
    " \\times ",
    matrix2latex(Sf, markdown = TRUE),
    " \\times ",
    matrix2latex(Vtf, markdown = TRUE),
    "$$"
  )
)
```
...
cat(
  str_c(
    ...
    matrix2latex(Uf, markdown = TRUE),
    " \\times ",
    matrix2latex(t(Uf), markdown = TRUE),
    " = ",
    matrix2latex(UUtf, markdown = TRUE),
    "$$"
  )
)
```
...
cat(
  str_c(
    "$$ VV^{\\mathrm {T}} = ",
    matrix2latex(t(Vtf), markdown = TRUE),
    " \\times ",
    matrix2latex(Vtf, markdown = TRUE),
    " = ",
    matrix2latex(VVtf, markdown = TRUE),
    "$$"
  )
)
```
